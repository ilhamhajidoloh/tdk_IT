...
export default function TeacherProfilePage() {
  ...
  return (
    <div className="profile-page profile-page-teacher min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Header */}
      ...
      <main className="p-4 max-w-4xl mx-auto pb-20">
        ...
        <div className="profile-card bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
          <div className="profile-hero bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-8">
