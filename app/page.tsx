        ...
        <div className="p-8 bg-white">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2.5 border border-[#00B900]/30 bg-[#00B900] hover:bg-[#00a000] text-white font-bold py-3 px-4 rounded-xl shadow-sm transition-all"
            >
